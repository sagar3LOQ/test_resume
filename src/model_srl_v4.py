...
from word2vec_srl_utils_v2 import DocumentFeatures
...
class genSRLVec():
	...
	def start(self):
		...
		print self.x_wt #, len(self.Ylabels)
...
## Print results 
	...
	def NFoldTest(self, iter_N=5,split =0.15,random_state=0):
		...
		self.saveNFoldResult2file(y_total,y_total,fn_total,"total_srl_data_v4.tsv")
...
if __name__ == '__main__': 
	...
	gsl.start()
	gsl.printResult()
	gsl.saveResult2file("srl_result_v4.tsv")
#	gsl.NFoldTest()
#	print gsl.getResult()
