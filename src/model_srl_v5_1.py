...
from word2vec_srl_utils_v3 import DocumentFeatures
...
class genSRLVec():
	...
	def train_predict(self):
		...
		self.savePredictResult2File(self.fn_test,self.Y_pred,"pred_output_srl_cconv.tsv")
...
#'/home/viswanath/workspace/resume_data/res_dir/model/w2v_model.mod' #
